...
import 'package:flutter_application_pokedex/pages/home_page/widgets/app_bar_home.dart';
import 'package:flutter_application_pokedex/pages/home_page/widgets/poke_item.dart';
import 'package:flutter_application_pokedex/pages/poke_detail/poke_detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    if (_pokemonStore.pokeAPI == null) {
      _pokemonStore.fetchePokemonList();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: <Widget>[
          Positioned(
            top: MediaQuery.of(context).padding.top - 220 / 2.9,
                                          ...
                                          onTap: () {
                                            ...
                                            Navigator.push(
                                              ...
                                              MaterialPageRoute(
                                                ...
                                                fullscreenDialog:
                                                    true, //PokeDetailPage(                                                 //index: index,
